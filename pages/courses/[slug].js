        ...
        <div className="max-w-5xl mx-auto">
          {
            ...
            <Message type="warning">
              ...
              <i className="block font-normal">In case of any questions, please contact info@udemy.com</i>
            </Message>
          }
          {
            courseState === "activated" &&
            <Message type="success">
              Udemy wishes you happy watching of the course.
            </Message>
          }
          {
            ...
            <Message type="danger">
              ...
              <i className="block font-normal">Please contact info@udemy.com</i>
            </Message>
          }
        </div>
      }
